         ...
         <div class="col-12">
            <div class="input-group mb-3" style="width: 100%; margin-top: 40px">
               ...
               <form action="/news/list.do" method="GET" class="d-flex">
                  ...
                  </select> <input type="text" class="form-control" name="searchText" placeholder="검색어를 입력해주세요." style="width: 500px;">
	         ...
	         <div class="row">
	        	 <c:forEach var="news" items="${list}">
		            <div class="col-12 col-md-6 col-lg-2 mb-4">
		               <div class="card">
		                  <img src="/resources/images/bombom.jpg" class="card-img-top" alt="뉴스 이미지" />
		                  <div class="card-body">
               ...
               <ul class="pagination" style="justify-content: center;">
               	  ...
               	  <c:choose>
	                  ...
	                  <li class="page-item"><a class="page-link" href="#"
               	  	...
               	  	<c:otherwise>
	                  <li class="page-item"><a class="page-link" href="/news/news.do?cpage=${pi.cpage - 1}&category=${param.category}&searchText=${param.searchText}"
	                     aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
               	  	</c:otherwise>
               	  </c:choose>
               	  
               	  <c:forEach var="page" begin="${pi.startPage}" end="${pi.endPage}">
	                  <li class="page-item"><a class="page-link" href="/news/news.do?cpage=${page}&category=${param.category}&searchText=${param.searchText}">${page}</a></li>
               	  </c:forEach>
