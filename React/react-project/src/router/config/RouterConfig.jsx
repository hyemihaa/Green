...
const router = createBrowserRouter([
  ...
  {
    path: "/free/*", // URL경로
    element: <FreeRoutes />, // 해당 URL로 왔을 때 이동할 페이지(가져온 파일)
  },
  {
    path: "/RouterPage",
  ...
  {
    path: "/FormHandlePage",
    element: <FormHandlePage />, // import한 별칭
  },
  {
    path: "/LiftingStatePage",
    element: <LiftingStatePage />, // import한 별칭
  },
  {
    path: "/LiftingStatePage2",
    element: <LiftingStatePage2 />, // import한 별칭
  },
  {
    path: "/Axiospage",
    element: <AxiosPage />, // import한 별칭
  },
